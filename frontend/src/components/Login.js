...
function Login(props) {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 pt-5 pb-10 mx-auto min-h-[calc(100vh-64px)]">
      ...
      <div className="w-full bg-amber-200 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-neutral-800 dark:border-neutral-700">
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form className="space-y-4 md:space-y-6" action="#">
            ...
            <button type="submit" onClick={handleLogin} className="w-full text-white bg-amber-500 hover:bg-amber-600 dark:bg-cyan-600 dark:hover:bg-cyan-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign in</button>
            <p className="text-sm text-black dark:text-neutral-400">
              Don’t have an account yet? <Link to="/register" className="font-medium text-amber-700 hover:underline dark:text-amber-500">Sign up</Link>
            </p>
          </form>
        </div>
      </div>
